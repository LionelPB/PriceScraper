...
Once you create your API key, copy it and set the **AGENTMAIL_APIKEY** variable in *main.py* to
the API key. *NOTE*: Once you close the dialog, you will not be able to see the API key again. 
